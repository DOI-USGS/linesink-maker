...
Contributions to linesink-maker are very welcome.  They are likely to
be accepted more quickly if they follow these guidelines.

In general, linesink-maker follows the conventions of the pandas project
where applicable.
...
- All existing tests should pass.  Please make sure that the test
  ...
  `Travis CI <https://travis-ci.com/aleaf/linesink-maker>`_.  Status on
