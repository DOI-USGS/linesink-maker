Contributing to Linesink-maker
===============================
...
------------------------------------------------
Bug reports are an important part of improving Linesink-maker. Having a complete bug report
...
To file a bug report or enhancement request, from the issues tab on the `Linesink-maker GitHub page <https://github.com/aleaf/linesink-maker>`_, select "New Issue".
...
#. Include a short, self-contained Python snippet reproducing the problem, along with the contents of your configuration file and the full error traceback.
   ...
   <https://github.github.com/github-flavored-markdown/>`_::
      ...
      ```python
      >>> import lsmaker
      >>> ls = lsmaker.LinesinkData('input.yml')
      ...
      ```
   ...
   e.g.::
      ...
      ```
#. Include the version of Linesink-maker that you are running, which can be obtained with:
...
Code contributions
------------------------------
Code contributions to Linesink-maker to fix bugs, implement new features or improve existing code are encouraged. Regardless of the context, consider `filing an issue`_ first to make others aware of the problem and allow for discussion on potential approaches to addressing it.

In general, Linesink-maker trys to follow the conventions of the pandas project where applicable. Contributions to Linesink-maker are likely to
...
- All existing tests should pass.  Please make sure that the test
  ...
  `GitHub Actions <https://github.com/aleaf/linesink-maker/actions>`_.  Status on
...
- Imports should be grouped with standard library imports first,
  3rd-party libraries next, and Linesink-maker imports third.  Within each
...
- Linesink-maker supports Python 3.7+ only.


Seven Steps for Contributing
~~~~~~~~~~~~~~~~~~~~~~~~~~~~

There are seven basic steps to contributing to *Linesink-maker*:

1) Fork the *Linesink-maker* git repository
2) Create a development environment
3) Install *Linesink-maker* dependencies
...
1) Forking the *Linesink-maker* repository using Git
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

To the new user, working with Git is one of the more daunting aspects of contributing to *Linesink-maker*.
It can very quickly become overwhelming, but sticking to the guidelines below will help keep the process
straightforward and mostly trouble free.  As always, if you are having difficulties please
feel free to ask for help.

The code is hosted on `GitHub <https://github.com/aleaf/linesink-maker>`_. To
...
You will need your own fork to work on the code. Go to the `Linesink-maker project
page <https://github.com/aleaf/linesink-maker>`_ and hit the ``Fork`` button. You will
want to clone your fork to your machine::

    git clone git@github.com:your-user-name/linesink-maker.git linesink-maker-yourname
    cd linesink-maker-yourname
    git remote add upstream git://github.com/aleaf/linesink-maker.git

This creates the directory `linesink-maker-yourname` and connects your repository to
the upstream (main project) *Linesink-maker* repository.
...
what the branch brings to *Linesink-maker*. You can have many shiny-new-features
...
This will replay your commits on top of the latest Linesink-maker git develop.  If this
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
A development environment is a virtual space where you can keep an independent installation of *Linesink-maker*.
...
An easy way to create a *Linesink-maker* development environment is as follows:
...
*Linesink-maker* is serious about testing and strongly encourages contributors to embrace
...
In general, tests are required for code pushed to *Linesink-maker*.  Therefore,
it is worth getting in the habit of writing tests ahead of time so this is never an issue.

*Linesink-maker* uses the `pytest testing system
...
install *Linesink-maker*) by typing::
...
The *Linesink-maker* documentation resides in the `docs` folder. Changes to the docs are
made by modifying the appropriate file in the `source` folder within `docs`.
The *Linesink-maker* docs use reStructuredText syntax, `which is explained here <http://www.sphinx-doc.org/en/stable/rest.html#rst-primer>`_
...
submit a pull request to have them integrated into the *Linesink-maker* code base.
...
Linesink-maker tries to follow the `PEP8 <http://www.python.org/dev/peps/pep-0008/>`_ standard. At this point, there's no enforcement of this, but I am considering implementing `Black <https://black.readthedocs.io/en/stable/>`_, which automates a code style that is PEP8-complient. Many editors perform automatic linting that makes following PEP8 easy.

Linesink-maker does use the `isort <https://github.com/timothycrosley/isort>`_ package to automatically organize import statements. isort can installed via pip::
...
From the root of the Linesink-maker repository, you should then install the
``pre-commit`` included in *Linesink-maker*::
...
.. _Issues tab: https://github.com/aleaf/linesink-maker/issues